...
class TrieTest {
	...
	void shouldFindWordsBetween() throws IOException {
		...
		final Set<String> wordsBetween = trie.getWordsBetween("innerContainer.index[", ']');
	...
	void shouldFindWordsBetweenOrStartingWith() throws IOException {
		...
		final Set<String> wordsBetween = trie.getWordsBetweenOrStartingWith("", '.');
		...
		assertTrue(wordsBetween.contains("fZonedDateTime"));
