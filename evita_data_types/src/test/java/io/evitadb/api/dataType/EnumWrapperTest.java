...
class EnumWrapperTest {
    ...
    void shouldParseEnumValueInValidFormat() {
        ...
        final EnumWrapper enumWrapper2 = EnumWrapper.fromString("WITH_VAT");
        assertEquals("WITH_VAT", enumWrapper2.getValue());
    ...
    void shouldFailToParseEnumValueInInvalidFormat() {
        ...
        assertThrows(IllegalArgumentException.class, () -> EnumWrapper.fromString("withVat"));
        assertThrows(IllegalArgumentException.class, () -> EnumWrapper.fromString("WITH-VAT"));
        assertThrows(IllegalArgumentException.class, () -> EnumWrapper.fromString("product-"));
