 ...
 * Evita DB requires all data to be sorted up front and there are cases when attribute sorting spans multiple data.
 ...
 */
@Data
public class Multiple implements Comparable<Multiple>, Serializable {
	private static final long serialVersionUID = -1899832326162360167L;
