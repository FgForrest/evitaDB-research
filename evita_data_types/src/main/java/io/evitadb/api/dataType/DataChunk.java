...
@ThreadSafe
@Immutable
public interface DataChunk<T extends Serializable> extends Iterable<T>, Serializable {

	/**
	 * Creates copy of the data chunk with replaced data but keeping total count and chunking constraints.
	 */
	<U extends Serializable> DataChunk<U> replaceData(List<U> newContent);
