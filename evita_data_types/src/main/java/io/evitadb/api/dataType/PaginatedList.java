...
@EqualsAndHashCode
@ToString
public class PaginatedList<T extends Serializable> implements DataChunk<T> {
	private static final long serialVersionUID = -480346362810326452L;
	...
	@Override
	public <U extends Serializable> PaginatedList<U> replaceData(List<U> newContent) {
		Assert.isTrue(data.size() == newContent.size(), "Old and new content should be of equal size!");
		return new PaginatedList<>(
			pageNumber, pageSize, totalRecordCount, newContent
		);
	}
