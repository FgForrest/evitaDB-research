...
/**
 * This exception is thrown when there are unmapped values left after {@link io.evitadb.api.data.DataObjectConverter#getOriginalForm(Serializable)}
 * has been finished.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public class IncompleteDeserializationException extends RuntimeException {
	private static final long serialVersionUID = 3710159236950227750L;
