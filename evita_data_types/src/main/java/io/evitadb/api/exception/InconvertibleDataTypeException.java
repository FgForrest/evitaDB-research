 ...
 */
public class InconvertibleDataTypeException extends RuntimeException {
	private static final long serialVersionUID = -117475978928554127L;
	@Getter private final Class<?> requestedType;
	@Getter private final Serializable value;

	public InconvertibleDataTypeException(Class<?> requestedType, Serializable value) {
		super(
