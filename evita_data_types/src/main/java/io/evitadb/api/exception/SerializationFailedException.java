...
/**
 * Exception is thrown when {@link io.evitadb.api.data.DataObjectConverter} fails to extract {@link io.evitadb.api.dataType.ComplexDataObject}
...
public class SerializationFailedException extends RuntimeException {
	private static final long serialVersionUID = 1730199175730118094L;
