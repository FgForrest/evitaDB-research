...
/**
 * This tests verifies basic properties of {@link FacetGroupsDisjunction} constraint.
 *
...
class FacetGroupsDisjunctionTest {
	...
	void shouldCreateViaFactoryClassWorkAsExpected() {
		...
		assertEquals("brand", facetGroupsDisjunction.getEntityType());
	...
	void shouldRecognizeApplicability() {
		...
		assertTrue(new FacetGroupsDisjunction("brand").isApplicable());
