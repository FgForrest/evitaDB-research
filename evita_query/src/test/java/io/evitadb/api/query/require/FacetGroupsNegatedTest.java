...
/**
 * This tests verifies basic properties of {@link FacetGroupsNegation} constraint.
 *
...
class FacetGroupsNegationTest {
	...
	void shouldCreateViaFactoryClassWorkAsExpected() {
		...
		assertEquals("brand", facetGroupsNegation.getEntityType());
	...
	void shouldRecognizeApplicability() {
		...
		assertTrue(new FacetGroupsNegation("brand").isApplicable());
