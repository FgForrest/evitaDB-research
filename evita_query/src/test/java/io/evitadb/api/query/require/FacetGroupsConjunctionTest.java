...
/**
 * This tests verifies basic properties of {@link FacetGroupsConjunction} constraint.
 *
...
class FacetGroupsConjunctionTest {
	...
	void shouldCreateViaFactoryClassWorkAsExpected() {
		...
		assertEquals("brand", facetGroupsConjunction.getEntityType());
	...
	void shouldRecognizeApplicability() {
		...
		assertTrue(new FacetGroupsConjunction("brand").isApplicable());
