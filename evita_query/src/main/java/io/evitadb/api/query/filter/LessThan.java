 ...
 */
public class LessThan extends AbstractAttributeFilterConstraintLeaf implements IndexUsingConstraint {
	private static final long serialVersionUID = -1531450217250657781L;

	private LessThan(Serializable... arguments) {
		super(arguments);
	}

	public <T extends Serializable & Comparable<?>> LessThan(String attributeName, T attributeValue) {
