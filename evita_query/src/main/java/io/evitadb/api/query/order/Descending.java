 ...
 */
public class Descending extends AbstractOrderAttributeConstraintLeaf {
	private static final long serialVersionUID = 116480345168914150L;

	private Descending(Serializable... arguments) {
		super(arguments);
	}

	public Descending(String attributeName) {
		super(attributeName);
	}
	...
	public OrderConstraint cloneWithArguments(Serializable[] newArguments) {
		return new Descending(newArguments);
	}
}
