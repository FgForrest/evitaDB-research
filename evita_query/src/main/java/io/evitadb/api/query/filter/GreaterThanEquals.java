 ...
 */
public class GreaterThanEquals extends AbstractAttributeFilterConstraintLeaf implements IndexUsingConstraint {
	private static final long serialVersionUID = -7346624370759447859L;

	private GreaterThanEquals(Serializable... arguments) {
		super(arguments);
	}

	public <T extends Serializable & Comparable<?>> GreaterThanEquals(String attributeName, T attributeValue) {
	...
	public FilterConstraint cloneWithArguments(Serializable[] newArguments) {
		return new GreaterThanEquals(newArguments);
	}
}
