 ...
 */
public class GreaterThan extends AbstractAttributeFilterConstraintLeaf implements IndexUsingConstraint {
	private static final long serialVersionUID = -4468753216715311483L;

	private GreaterThan(Serializable... arguments) {
		super(arguments);
	}

	public <T extends Serializable & Comparable<?>> GreaterThan(String attributeName, T attributeValue) {
