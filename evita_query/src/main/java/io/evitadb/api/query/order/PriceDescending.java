 ...
 */
public class PriceDescending extends AbstractOrderConstraintLeaf {
	private static final long serialVersionUID = 6400117700527216935L;

	private PriceDescending(Serializable... arguments) {
		super(arguments);
	}
	...
	public OrderConstraint cloneWithArguments(Serializable[] newArguments) {
		return new PriceDescending(newArguments);
	}
}
