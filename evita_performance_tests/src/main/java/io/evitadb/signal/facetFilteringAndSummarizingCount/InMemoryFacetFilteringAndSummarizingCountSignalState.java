...
package io.evitadb.signal.facetFilteringAndSummarizingCount;
...
/**
 * Evita DB in memory implementation specific implementation of {@link ClientFacetFilteringAndSummarizingCountState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class InMemoryFacetFilteringAndSummarizingCountSignalState
	extends ClientFacetFilteringAndSummarizingCountState<EvitaRequest, EvitaCatalogConfiguration, EntityCollection, Catalog, Transaction, EvitaSession>
