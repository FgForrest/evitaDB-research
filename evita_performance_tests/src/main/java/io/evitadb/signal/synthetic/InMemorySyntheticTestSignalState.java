...
package io.evitadb.signal.synthetic;
...
/**
 * Evita DB in memory implementation specific implementation of {@link ClientAttributeFilteringState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class InMemorySyntheticTestSignalState
	extends ClientSyntheticTestState<EvitaRequest, EvitaCatalogConfiguration, EntityCollection, Catalog, Transaction, EvitaSession>
