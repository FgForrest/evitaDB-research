...
public class Statistics {
	...
	public void recordResponseEntityReference(long durationInNanos, EvitaResponseBase<EntityReference> response) {
	...
	public void recordResponseSealedEntity(long durationInNanos, EvitaResponseBase<SealedEntity> response) {
		this.queryCount.incrementAndGet();
		this.durationInNanos.addAndGet(durationInNanos);
