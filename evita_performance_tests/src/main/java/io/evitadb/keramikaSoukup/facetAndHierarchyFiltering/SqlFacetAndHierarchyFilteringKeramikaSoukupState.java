...
package io.evitadb.keramikaSoukup.facetAndHierarchyFiltering;
...
/**
 * Evita DB PostgreSQL implementation specific implementation of {@link ClientFacetAndHierarchyFilteringState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class SqlFacetAndHierarchyFilteringKeramikaSoukupState
	extends ClientFacetAndHierarchyFilteringState<SqlEvitaRequest, SqlEvitaCatalogConfiguration, SqlEntityCollection, SqlCatalog, SqlTransaction, SqlEvitaSession>
