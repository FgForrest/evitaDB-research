 ...
 */
public interface InMemoryCatalogSetup
	extends CatalogSetup<EvitaRequest, EvitaCatalogConfiguration, EntityCollection, Catalog, Transaction, EvitaSession>,
	TestFileSupport {

	@Override
	default Evita createEmptyEvitaInstance(String catalogName) {
