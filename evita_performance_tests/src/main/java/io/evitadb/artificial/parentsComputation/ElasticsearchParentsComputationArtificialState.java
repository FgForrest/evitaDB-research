...
/**
 * Evita DB Elastic search implementation specific implementation of {@link ArtificialParentsComputationState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class ElasticsearchParentsComputationArtificialState
	extends ArtificialParentsComputationState<EsEvitaRequest, EsEvitaCatalogConfiguration, EsEntityCollection, EsCatalog, EsTransaction, EsEvitaSession>
