...
/**
 * Evita DB in memory implementation specific implementation of {@link ArtificialParentsComputationState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class InMemoryParentsComputationArtificialState
	extends ArtificialParentsComputationState<EvitaRequest, EvitaCatalogConfiguration, EntityCollection, Catalog, Transaction, EvitaSession>
