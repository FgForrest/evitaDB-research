...
/**
 * Evita DB PostgreSQL implementation specific implementation of {@link ArtificialPriceHistogramState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class SqlPriceHistogramArtificialState
	extends ArtificialPriceHistogramState<SqlEvitaRequest, SqlEvitaCatalogConfiguration, SqlEntityCollection, SqlCatalog, SqlTransaction, SqlEvitaSession>
