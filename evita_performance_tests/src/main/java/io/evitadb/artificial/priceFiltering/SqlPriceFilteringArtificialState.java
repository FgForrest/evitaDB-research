...
/**
 * Evita DB PostgreSQL implementation specific implementation of {@link ArtificialPriceFilteringState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class SqlPriceFilteringArtificialState
	extends ArtificialPriceFilteringState<SqlEvitaRequest, SqlEvitaCatalogConfiguration, SqlEntityCollection, SqlCatalog, SqlTransaction, SqlEvitaSession>
