...
package io.evitadb.artificial.randomSingleRead;
...
/**
 * Base state class for {@link io.evitadb.artificial.ArtificialEntitiesBenchmark#singleEntityRead_InMemory(InMemorySingleReadArtificialState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public abstract class ArtificialSingleReadState<REQUEST extends EvitaRequestBase, CONFIGURATION extends CatalogConfiguration, COLLECTION extends EntityCollectionBase<REQUEST>, CATALOG extends CatalogBase<REQUEST, CONFIGURATION, COLLECTION>, TRANSACTION extends TransactionBase, SESSION extends EvitaSessionBase<REQUEST, CONFIGURATION, COLLECTION, CATALOG, TRANSACTION>> extends ArtificialFullDatabaseState<REQUEST, CONFIGURATION, COLLECTION, CATALOG, TRANSACTION, SESSION> {
	/**
	...
	public void prepareCall() {
		...
		this.query = Query.query(
			...
			filterBy(
				and(
					primaryKey(random.nextInt(PRODUCT_COUNT) + 1),
