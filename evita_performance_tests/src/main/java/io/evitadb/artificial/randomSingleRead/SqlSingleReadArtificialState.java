...
/**
 * Evita DB PostgresQL implementation specific implementation of {@link ArtificialSingleReadState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class SqlSingleReadArtificialState
	extends ArtificialSingleReadState<SqlEvitaRequest, SqlEvitaCatalogConfiguration, SqlEntityCollection, SqlCatalog, SqlTransaction, SqlEvitaSession>
