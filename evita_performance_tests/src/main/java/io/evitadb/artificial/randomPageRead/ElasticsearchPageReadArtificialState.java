...
/**
 * Evita DB in memory implementation specific implementation of {@link ArtificialPageReadState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class ElasticsearchPageReadArtificialState
	extends ArtificialPageReadState<EsEvitaRequest, EsEvitaCatalogConfiguration, EsEntityCollection, EsCatalog, EsTransaction, EsEvitaSession>
