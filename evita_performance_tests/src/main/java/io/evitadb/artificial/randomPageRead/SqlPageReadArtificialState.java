...
/**
 * Evita DB PostgreSQL implementation specific implementation of {@link ArtificialPageReadState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class SqlPageReadArtificialState
	extends ArtificialPageReadState<SqlEvitaRequest, SqlEvitaCatalogConfiguration, SqlEntityCollection, SqlCatalog, SqlTransaction, SqlEvitaSession>
