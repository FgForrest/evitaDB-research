...
/**
 * Evita DB PostgreSQL implementation specific implementation of {@link ArtificialFacetFilteringState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class SqlFacetFilteringArtificialState
	extends ArtificialFacetFilteringState<SqlEvitaRequest, SqlEvitaCatalogConfiguration, SqlEntityCollection, SqlCatalog, SqlTransaction, SqlEvitaSession>
