...
/**
 * Evita DB in memory implementation specific implementation of {@link ArtificialFacetFilteringState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class InMemoryFacetFilteringArtificialState
	extends ArtificialFacetFilteringState<EvitaRequest, EvitaCatalogConfiguration, EntityCollection, Catalog, Transaction, EvitaSession>
