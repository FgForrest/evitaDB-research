...
/**
 * Evita DB Elastic search implementation specific implementation of {@link ArtificialFacetFilteringState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class ElasticsearchFacetFilteringArtificialState
	extends ArtificialFacetFilteringState<EsEvitaRequest, EsEvitaCatalogConfiguration, EsEntityCollection, EsCatalog, EsTransaction, EsEvitaSession>
