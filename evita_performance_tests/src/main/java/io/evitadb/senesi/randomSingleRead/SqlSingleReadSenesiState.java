...
/**
 * Evita DB PostgresQL implementation specific implementation of {@link ClientSingleReadState}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
@State(Scope.Benchmark)
public class SqlSingleReadSenesiState
	extends ClientSingleReadState<SqlEvitaRequest, SqlEvitaCatalogConfiguration, SqlEntityCollection, SqlCatalog, SqlTransaction, SqlEvitaSession>
