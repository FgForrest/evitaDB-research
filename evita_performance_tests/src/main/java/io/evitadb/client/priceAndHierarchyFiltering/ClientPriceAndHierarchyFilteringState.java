...
package io.evitadb.client.priceAndHierarchyFiltering;
...
/**
 * Base state class for {@link io.evitadb.senesi.SenesiBenchmark#priceAndHierarchyFiltering_InMemory(InMemoryPriceAndHierarchyFilteringSenesiState, Blackhole)}.
 * See benchmark description on the method.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public abstract class ClientPriceAndHierarchyFilteringState<REQUEST extends EvitaRequestBase, CONFIGURATION extends CatalogConfiguration, COLLECTION extends EntityCollectionBase<REQUEST>, CATALOG extends CatalogBase<REQUEST, CONFIGURATION, COLLECTION>, TRANSACTION extends TransactionBase, SESSION extends EvitaSessionBase<REQUEST, CONFIGURATION, COLLECTION, CATALOG, TRANSACTION>>
