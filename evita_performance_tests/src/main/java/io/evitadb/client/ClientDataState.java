 ...
 */
public abstract class ClientDataState<REQUEST extends EvitaRequestBase, CONFIGURATION extends CatalogConfiguration, COLLECTION extends EntityCollectionBase<REQUEST>, CATALOG extends CatalogBase<REQUEST, CONFIGURATION, COLLECTION>, TRANSACTION extends TransactionBase, SESSION extends EvitaSessionBase<REQUEST, CONFIGURATION, COLLECTION, CATALOG, TRANSACTION>>
	implements CatalogSetup<REQUEST, CONFIGURATION, COLLECTION, CATALOG, TRANSACTION, SESSION>, TestConstants {
	/**
	 ...
	 */
	@Getter protected EvitaSessionBase<REQUEST, CONFIGURATION, COLLECTION, CATALOG, TRANSACTION> session;
	/**
	 ...
	 */
	protected EntityReference createEntity(@Nonnull SESSION session, @Nonnull EntityBuilder it) {
