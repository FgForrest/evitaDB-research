...
import io.evitadb.api.schema.AssociatedDataSchemaBuilder;
 ...
 */
class ExistingAssociatedDataBuilderTest {
	private AssociatedData initialAssociatedData;

	@BeforeEach
	void setUp() {
		initialAssociatedData = new InitialAssociatedDataBuilder(new EntitySchema("whatever"))
				.setAssociatedData("int", 1)
				.setAssociatedData("range", NumberRange.between(4, 8))
	...
	void shouldOverrideExistingAssociatedDataWithNewValue() {
		final AssociatedDataBuilder builder = new ExistingAssociatedDataBuilder(initialAssociatedData)
	...
	void shouldRespectExistingSchemaEarlyOnWhenSettingAssociatedDatas() {
		...
		new EntitySchemaBuilder(
				...
				.withAssociatedData("int", Integer.class, AssociatedDataSchemaBuilder::localized)
				.verifySchemaStrictly()
				.withLocale(Locale.ENGLISH)
				.applyChanges();

		final AssociatedData attrs = new InitialAssociatedDataBuilder(schemaHolder.get())
				.setAssociatedData("string", "Hi")
				.setAssociatedData("int", Locale.ENGLISH, 5)
				.build();

		final ExistingAssociatedDataBuilder attrBuilder = new ExistingAssociatedDataBuilder(attrs);
	...
	void shouldReturnOriginalAssociatedDataInstanceWhenNothingHasChanged() {
		final AssociatedData newAssociatedData = new ExistingAssociatedDataBuilder(initialAssociatedData)
				.setAssociatedData("int", 1)
				.setAssociatedData("range", NumberRange.between(4, 8))
				.setAssociatedData("bigDecimal", new BigDecimal("1.123"))
				.setAssociatedData("greetings", Locale.ENGLISH, "Hello")
