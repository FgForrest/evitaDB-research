 ...
 */
class InitialAssociatedDataBuilderTest {
	final InitialAssociatedDataBuilder associatedData = new InitialAssociatedDataBuilder(new EntitySchema("whatever"));
	...
	void shouldReturnAssociatedDataNames() {
		final AssociatedData associatedData = this.associatedData
				...
				.setAssociatedData("def", NumberRange.between(4, 8))
				.build();
	...
	void shouldSupportLocalizedAssociatedData() {
		...
		assertEquals(NumberRange.between(4, 8), builder.getAssociatedData("def"));
		...
		assertEquals(NumberRange.between(4, 8), associatedData.getAssociatedData("def"));
	...
	void shouldRespectExistingSchemaEarlyOnWhenSettingAssociatedData() {
		...
		final InitialAssociatedDataBuilder attrBuilder = new InitialAssociatedDataBuilder(schemaHolder.get());
