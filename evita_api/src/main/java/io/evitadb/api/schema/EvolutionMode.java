...
public enum EvolutionMode {
	...
	/**
	 * When new reference type is encountered, it is silently added. It's linked to other Evita DB entity when
	 * the {@link Reference#getReferencedEntity()} or {@link Reference#getGroup()} respectively matches by
