...
public interface AttributesContract extends Serializable {
	 ...
	 */
	@Nullable
	<T extends Serializable & Comparable<?>> T getAttribute(@Nonnull String attributeName);
	 ...
	 */
	@Nullable
	<T extends Serializable & Comparable<?>> T[] getAttributeArray(@Nonnull String attributeName);
	 ...
	 */
	@Nullable
	AttributeValue getAttributeValue(@Nonnull String attributeName);

	/**
	 * Returns value associated with the key or null when the attribute is missing.
	 * When localized attribute is not found it is looked up in generic (non-localized) attributes. This makes this
	 * method safest way how to lookup for attribute if caller doesn't know whether it is localized or not.
	 *
	 * @throws ClassCastException when attribute is of different type than expected
	 */
	@Nullable
	<T extends Serializable & Comparable<?>> T getAttribute(@Nonnull String attributeName, @Nonnull Locale locale);
	 ...
	 */
	@Nullable
	<T extends Serializable & Comparable<?>> T[] getAttributeArray(@Nonnull String attributeName, @Nonnull Locale locale);
	 ...
	 */
	@Nullable
	AttributeValue getAttributeValue(@Nonnull String attributeName, @Nonnull Locale locale);
	...
	class AttributeValue implements Versioned, Droppable, Serializable, Comparable<AttributeValue>, ContentComparator<AttributeValue> {
		private static final long serialVersionUID = -5387437940533059959L;
		 ...
		 */
		public static AttributeValue createEmptyComparableAttributeValue(AttributeKey attributeKey) {
