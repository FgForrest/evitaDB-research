...
/**
 * This interface defines a constraint that a predicate must be serializable. Using lambdas for this
...
public interface SerializablePredicate<T> extends Serializable, Predicate<T> {
	...
	class OrPredicate<T> implements SerializablePredicate<T> {
		private static final long serialVersionUID = -4534779807816763893L;
	...
	class ExistsPredicate<T extends Droppable> implements SerializablePredicate<T> {
		...
		private static final long serialVersionUID = 7176072107501299504L;
