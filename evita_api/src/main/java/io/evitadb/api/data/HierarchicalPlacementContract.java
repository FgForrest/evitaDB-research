 ...
 * Hierarchy can limit returned entities by using filtering constraints {@link WithinHierarchy} / {@link WithinRootHierarchy}.
 * It's also used for computation of extra data - such as {@link Parents}. It can also invert type of returned entities
 * in case requirement {@link HierarchyStatistics} is used.
 *
