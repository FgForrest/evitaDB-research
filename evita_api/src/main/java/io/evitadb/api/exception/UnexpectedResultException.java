...
/**
 * This exception is thrown when {@link EvitaSessionBase#query(Query, Class)} contains different object
...
public class UnexpectedResultException extends RuntimeException {
	private static final long serialVersionUID = 334947152990851707L;
