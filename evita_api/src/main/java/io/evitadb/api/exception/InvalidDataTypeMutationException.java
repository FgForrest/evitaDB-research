...
public class InvalidDataTypeMutationException extends InvalidMutationException {
	private static final long serialVersionUID = -333068314618284721L;
	@Getter private final Class<?> expectedType;
	@Getter private final Class<?> actualType;

	public InvalidDataTypeMutationException(String message, Class<?> expectedType, Class<?> actualType) {
		super(message);
