 ...
 */
public class SqlEvitaEntityReferenceResponse extends EvitaResponseBase<EntityReference> {

	public SqlEvitaEntityReferenceResponse(@Nonnull Query sourceQuery, @Nonnull DataChunk<EntityReference> recordPage) {
		super(sourceQuery, recordPage);
	}

	public SqlEvitaEntityReferenceResponse(@Nonnull Query sourceQuery, @Nonnull DataChunk<EntityReference> recordPage, EvitaResponseExtraResult... additionalResults) {
