...
/**
 * Implementation of {@link FilterConstraintTranslator} which converts constraint {@link LessThan} to generic {@link SqlPart}
 *
...
public class LessThanTranslator extends AttributeFilterConstraintTranslator<LessThan> {
    ...
    @Override
    public SqlPart translate(@Nonnull LessThan constraint, @Nonnull FilterTranslatingContext ctx) {
