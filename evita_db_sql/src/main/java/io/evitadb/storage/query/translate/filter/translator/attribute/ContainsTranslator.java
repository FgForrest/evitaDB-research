...
/**
 * Implementation of {@link FilterConstraintTranslator} which converts constraint {@link Contains} to generic {@link SqlPart}
 *
 * @author Lukáš Hornych 2021
 */
public class ContainsTranslator extends AttributeFilterConstraintTranslator<Contains> {

    @Override
    public SqlPart translate(@Nonnull Contains constraint, @Nonnull FilterTranslatingContext ctx) {
