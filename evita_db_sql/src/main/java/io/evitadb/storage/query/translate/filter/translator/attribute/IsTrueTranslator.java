...
/**
 * Implementation of {@link FilterConstraintTranslator} which converts constraint {@link IsTrue} to generic {@link SqlPart}
 *
...
public class IsTrueTranslator extends AttributeFilterConstraintTranslator<IsTrue> {
    ...
    @Override
    public SqlPart translate(@Nonnull IsTrue constraint, @Nonnull FilterTranslatingContext ctx) {
