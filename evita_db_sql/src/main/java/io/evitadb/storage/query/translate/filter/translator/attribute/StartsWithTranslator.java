...
/**
 * Implementation of {@link FilterConstraintTranslator} which converts constraint {@link StartsWith} to generic {@link SqlPart}
 *
 * @author Lukáš Hornych 2021
 */
public class StartsWithTranslator extends AttributeFilterConstraintTranslator<StartsWith> {

    @Override
    public SqlPart translate(@Nonnull StartsWith constraint, @Nonnull FilterTranslatingContext ctx) {
