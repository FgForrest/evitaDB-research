...
/**
 * Facet condition with OR relation for computing facet summary and statistics
 *
 * @author Lukáš Hornych 2021
 */
public class SummaryOrFacetCondition extends AbstractOrFacetCondition {

    public SummaryOrFacetCondition(GroupReference group, String serializedEntityType, int... facetIds) {
    ...
    public FacetCondition combine(GroupReference group, String serializedEntityType, int... facetIds) {
        ...
        return new SummaryOrFacetCondition(
                getGroup(),
