...
/**
 * Implementation of {@link FilterConstraintTranslator} for {@link PriceValidIn} constraint.
 *
 ...
 *
 * However filter visitor still needs to know about some translator for {@link PriceValidIn} so this implementation
 * acts as placeholder.
 *
 * @author Lukáš Hornych 2021
 */
public class PriceValidInTranslator implements FilterConstraintTranslator<PriceValidIn> {

    @Override
    public SqlPart translate(@Nonnull PriceValidIn constraint, @Nonnull FilterTranslatingContext ctx) {
