...
/**
 * Implementation of {@link FilterConstraintTranslator} which converts constraint {@link IsFalse} to generic {@link SqlPart}
 *
 * @author Lukáš Hornych 2021
 */
public class IsFalseTranslator extends AttributeFilterConstraintTranslator<IsFalse> {

    @Override
    public SqlPart translate(@Nonnull IsFalse constraint, @Nonnull FilterTranslatingContext ctx) {
