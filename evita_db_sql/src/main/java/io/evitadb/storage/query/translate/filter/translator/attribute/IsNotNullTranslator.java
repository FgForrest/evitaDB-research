...
/**
 * Implementation of {@link FilterConstraintTranslator} which converts constraint {@link IsNotNull} to generic {@link SqlPart}
 *
...
public class IsNotNullTranslator extends AttributeFilterConstraintTranslator<IsNotNull> {
    ...
    @Override
    public SqlPart translate(@Nonnull IsNotNull constraint, @Nonnull FilterTranslatingContext ctx) {
