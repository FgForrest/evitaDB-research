...
import io.evitadb.storage.query.builder.facet.AbstractOrFacetCondition;
...
/**
 * Facet condition with OR relation for finding entities by selected facets
 *
 * @author Lukáš Hornych 2021
 */
public class FilterOrFacetCondition extends AbstractOrFacetCondition {

    private final FilterTranslatingContext ctx;

    public FilterOrFacetCondition(FilterTranslatingContext ctx, GroupReference group, String serializedEntityType, int... facetIds) {
    ...
    public FacetCondition combine(GroupReference group, String serializedEntityType, int... facetIds) {
        ...
        return new FilterOrFacetCondition(
                ctx,
                getGroup(),
