...
/**
 * Facet condition with NOT relation for computing facet summary and statistics
 *
 * @author Lukáš Hornych 2021
 */
public class SummaryNotFacetCondition extends AbstractNotFacetCondition {

    public SummaryNotFacetCondition(GroupReference group, String serializedEntityType, int... facetIds) {
        super(group, serializedEntityType, facetIds);
    }

    @Override
    public SqlPart get() {
        final StringBuilder sqlBuilder = new StringBuilder("not(");
    ...
    public FacetCondition combine(GroupReference group, String serializedEntityType, int... facetIds) {
        ...
        return new SummaryNotFacetCondition(
                getGroup(),
