...
/**
 * Implementation of {@link FilterConstraintTranslator} for {@link PriceInPriceLists} constraint.
 *
 * This implementation actually does nothing because price in price lists logic is currently handled separately of
 ...
 *
 * However filter visitor still needs to know about some translator for {@link PriceInPriceLists} so this implementation
 * acts as placeholder.
 *
 * @author Lukáš Hornych 2021
 */
public class PriceInPriceListsTranslator implements FilterConstraintTranslator<PriceInPriceLists> {

    @Override
    public SqlPart translate(@Nonnull PriceInPriceLists constraint, @Nonnull FilterTranslatingContext ctx) {
