...
/**
 * Implementation of {@link FilterConstraintTranslator} which converts constraint {@link Equals} to generic {@link SqlPart}
 *
...
public class EqualsTranslator extends AttributeFilterConstraintTranslator<Equals> {
    ...
    @Override
    public SqlPart translate(@Nonnull Equals constraint, @Nonnull FilterTranslatingContext ctx) {
