...
public class VersionedKryoFactory {
     ...
     * implementation. This method should play well with {@link KryoFactory.SchemaKryoConfigurer} and {@link KryoFactory.EntityKryoConfigurer}
    ...
    public static VersionedKryo createKryo(long version, ClassResolver classResolver) {
        return initializeKryo(new VersionedKryo(version, classResolver), new DefaultKryoSerializationHelper());
    }
