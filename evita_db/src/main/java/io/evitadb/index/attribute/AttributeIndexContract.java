...
public interface AttributeIndexContract {
	...
	void insertUniqueAttribute(
		@Nonnull AttributeSchema attributeSchema, @Nonnull Set<Locale> allowedLocales, @Nullable Locale locale,
	...
	void insertSortAttribute(
		AttributeSchema attributeSchema, @Nonnull Set<Locale> allowedLocales,
