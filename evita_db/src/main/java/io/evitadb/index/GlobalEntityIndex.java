 ...
 * in the {@link io.evitadb.api.EntityCollection} and it's the broadest index available. The global index is always
...
public class GlobalEntityIndex extends EntityIndex implements VoidTransactionMemoryProducer<GlobalEntityIndex> {
	...
	public GlobalEntityIndex(int primaryKey, @Nonnull EntityIndexKey entityIndexKey, @Nonnull Supplier<EntitySchema> schemaAccessor) {
		super(primaryKey, entityIndexKey, schemaAccessor);
		this.priceIndex = new PriceSuperIndex();
	}

	public GlobalEntityIndex(int primaryKey, @Nonnull EntityIndexKey entityIndexKey, int version, @Nonnull Supplier<EntitySchema> schemaAccessor, @Nonnull Bitmap entityIds, @Nonnull Map<Locale, TransactionalBitmap> entityIdsByLanguage, @Nonnull AttributeIndex attributeIndex, @Nonnull PriceSuperIndex priceIndex, @Nonnull HierarchyIndex hierarchyIndex, @Nonnull FacetIndex facetIndex) {
	...
	@Override
	public GlobalEntityIndex createCopyWithMergedTransactionalMemory(@Nullable Void layer, @Nonnull TransactionalLayerMaintainer transactionalLayer, Transaction transaction) {
