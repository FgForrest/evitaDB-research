...
import io.evitadb.storage.model.storageParts.index.EntityIndexKeyAccessor;
...
@AllArgsConstructor
@Data
public class EntityIndexKey implements Serializable, Comparable<EntityIndexKey>, EntityIndexKeyAccessor {
	...
	public EntityIndexKey(EntityIndexType type) {
		this.type = type;
