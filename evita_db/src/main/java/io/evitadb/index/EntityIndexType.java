...
public enum EntityIndexType {
	 ...
	 * This index is used when query contains {@link ReferenceHavingAttribute} constraint
	 * is used.
	 */
	 ...
	 * entity with {@link io.evitadb.api.data.HierarchicalPlacementContract} defined.
	 */
