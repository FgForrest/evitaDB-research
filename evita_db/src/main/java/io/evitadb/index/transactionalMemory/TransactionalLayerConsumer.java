 ...
 * immutable state and by using {@link TransactionalLayerProducer#createCopyWithMergedTransactionalMemory(Object, TransactionalLayerMaintainer, io.evitadb.api.Transaction)}
...
public interface TransactionalLayerConsumer {
	 ...
	 * which internally calls {@link TransactionalLayerProducer#createCopyWithMergedTransactionalMemory(Object, TransactionalLayerMaintainer, io.evitadb.api.Transaction)}
