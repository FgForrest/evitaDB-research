...
public class TransactionalRangePoint implements TransactionalObject<TransactionalRangePoint>, VoidTransactionMemoryProducer<TransactionalRangePoint>, RangePoint<TransactionalRangePoint>, TransactionalCreatorMaintainer, Serializable {
	...
	@Override
	public TransactionalRangePoint createCopyWithMergedTransactionalMemory(Void layer, @Nonnull TransactionalLayerMaintainer transactionalLayer, Transaction transaction) {
	...
	public void removeFromTransactionalMemory() {
		TransactionalMemory.removeTransactionalMemoryLayerIfExists(starts);
		TransactionalMemory.removeTransactionalMemoryLayerIfExists(ends);
	}

	@Override
	public TransactionalRangePoint makeClone() {
		return new TransactionalRangePoint(threshold, getStarts(), getEnds());
	}
