 ...
 */
@ToString
public class PriceRecordInnerRecordSpecific implements PriceRecordContract {
	private static final long serialVersionUID = 3145108662152707264L;
	...
	/**
	 * Refers to {@link PriceContract#getInnerRecordId()}.
	...
	public PriceRecordInnerRecordSpecific(int internalPriceId, int priceId, int entityPrimaryKey, int innerRecordId, int priceWithVat, int priceWithoutVat) {
