 ...
 */
public class PriceIndexKey extends io.evitadb.api.data.key.PriceKey implements Comparable<PriceIndexKey> {
	...
	public PriceIndexKey(@Nonnull Serializable priceList, @Nonnull Currency currency, @Nonnull PriceInnerRecordHandling recordHandling) {
