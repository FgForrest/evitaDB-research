...
/**
 * AttributeIndexContract describes the API of {@link PriceIndexContract} that maintains data structures for fast
...
public interface PriceIndexContract {
	 ...
	 */
	@Nonnull
	Stream<? extends PriceListAndCurrencyPriceIndex> getPriceIndexesStream(@Nonnull Currency currency, @Nonnull PriceInnerRecordHandling innerRecordHandling);

	/**
	 * Returns stream of all {@link PriceListAndCurrencyPriceSuperIndex indexes} that relates to passed price list.
	 */
	@Nonnull
	Stream<? extends PriceListAndCurrencyPriceIndex> getPriceIndexesStream(@Nonnull Serializable priceListName, @Nonnull PriceInnerRecordHandling innerRecordHandling);
	 ...
	 */
	@Nullable
	PriceListAndCurrencyPriceIndex getPriceIndex(@Nonnull Serializable priceList, @Nonnull Currency currency, @Nonnull PriceInnerRecordHandling innerRecordHandling);
