 ...
 */
public class EvitaEntityReferenceResponse extends EvitaResponseBase<EntityReference> {
	...
	public EvitaEntityReferenceResponse(@Nonnull Query sourceQuery, @Nonnull DataChunk<EntityReference> recordPage, EvitaResponseExtraResult... additionalResults) {
