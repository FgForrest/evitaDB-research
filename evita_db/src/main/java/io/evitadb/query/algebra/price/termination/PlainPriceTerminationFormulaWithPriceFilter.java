 ...
 *
 * This formula consumes and produces {@link Formula} of reduced {@link PriceRecord#getEntityPrimaryKey() entity ids}
			...
			while (entityIdIterator.hasNext()) {
				...
				for (int i = 0; i < entityIdIterator.getPeek(); i++) {
					...
					if (noPriceFoundAtAll) {
						throw new IllegalStateException("No price found for entity with id " + entityId + "!");
					}
				}
			}
