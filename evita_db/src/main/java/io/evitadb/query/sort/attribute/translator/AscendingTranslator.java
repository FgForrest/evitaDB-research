...
/**
 * This implementation of {@link OrderingConstraintTranslator} converts {@link Ascending} to {@link Sorter}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public class AscendingTranslator implements OrderingConstraintTranslator<Ascending> {

	@Override
	public Sorter apply(Ascending ascending, OrderByVisitor orderByVisitor) {
