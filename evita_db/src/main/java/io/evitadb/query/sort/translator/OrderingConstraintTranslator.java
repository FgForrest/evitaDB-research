...
package io.evitadb.query.sort.translator;
 ...
 */
@FunctionalInterface
public interface OrderingConstraintTranslator<T extends OrderConstraint> extends BiFunction<T, OrderByVisitor, Sorter> {
}
