...
/**
 * This implementation of {@link FilteringConstraintTranslator} converts {@link LessThanEquals} to {@link AbstractFormula}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public class LessThanEqualsTranslator implements FilteringConstraintTranslator<LessThanEquals> {

	@SuppressWarnings({"rawtypes", "unchecked"})
	@Override
	@Nonnull
	public Formula translate(@Nonnull LessThanEquals filterConstraint, @Nonnull FilterByVisitor filterByVisitor) {
