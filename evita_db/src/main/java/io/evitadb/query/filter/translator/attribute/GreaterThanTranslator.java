 ...
 */
public class GreaterThanTranslator implements FilteringConstraintTranslator<GreaterThan> {

	@SuppressWarnings({"rawtypes", "unchecked"})
	@Override
	@Nonnull
	public Formula translate(@Nonnull GreaterThan filterConstraint, @Nonnull FilterByVisitor filterByVisitor) {
