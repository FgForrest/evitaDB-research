...
import io.evitadb.api.query.filter.StartsWith;
...
/**
 * This implementation of {@link FilteringConstraintTranslator} converts {@link StartsWith} to {@link AbstractFormula}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public class StartsWithTranslator implements FilteringConstraintTranslator<StartsWith> {

	@Override
	@Nonnull
	public Formula translate(@Nonnull StartsWith filterConstraint, @Nonnull FilterByVisitor filterByVisitor) {
	...
	@Nonnull
	public static Predicate<Object> getPredicate(String textToSearch) {
		return attr -> attr != null && ((String) attr).startsWith(textToSearch);
	}

	@Nonnull
	public static Predicate<Object> getArrayPredicate(String textToSearch) {
		return attr -> attr != null && Arrays.stream((Object[])attr).anyMatch(it -> ((String) it).startsWith(textToSearch));
	}
