 ...
 * computed result with record ids that fulfill the constraint condition.
 *
...
public interface FilteringConstraintTranslator<T extends FilterConstraint> {
	...
	/**
	 * Translates the constraint to the {@link AbstractFormula} that returns primary keys that match the constraint.
	 */
	@Nonnull
