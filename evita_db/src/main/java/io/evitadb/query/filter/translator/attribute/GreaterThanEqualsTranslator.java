...
/**
 * This implementation of {@link FilteringConstraintTranslator} converts {@link GreaterThan} to {@link AbstractFormula}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public class GreaterThanEqualsTranslator implements FilteringConstraintTranslator<GreaterThanEquals> {

	@SuppressWarnings({"rawtypes", "unchecked"})
	@Override
	@Nonnull
	public Formula translate(@Nonnull GreaterThanEquals filterConstraint, @Nonnull FilterByVisitor filterByVisitor) {
