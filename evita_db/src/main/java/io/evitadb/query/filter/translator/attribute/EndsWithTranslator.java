...
/**
 * This implementation of {@link FilteringConstraintTranslator} converts {@link EndsWith} to {@link AbstractFormula}.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2021
 */
public class EndsWithTranslator implements FilteringConstraintTranslator<EndsWith> {

	@Nonnull
	@Override
	public Formula translate(@Nonnull EndsWith filterConstraint, @Nonnull FilterByVisitor filterByVisitor) {
	...
	public static Predicate<Object> getPredicate(String textToSearch) {
		return attr -> attr != null && ((String) attr).endsWith(textToSearch);
	}

	@Nonnull
	public static Predicate<Object> getArrayPredicate(String textToSearch) {
		return attr -> attr != null && Arrays.stream((Object[])attr).anyMatch(it -> ((String) it).endsWith(textToSearch));
	}
