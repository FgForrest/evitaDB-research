 ...
 */
public class PrimaryKeyTranslator implements FilteringConstraintTranslator<PrimaryKey> {

	@Override
	public @Nonnull
	AbstractFormula translate(@Nonnull PrimaryKey filterConstraint, @Nonnull FilterByVisitor filterByVisitor) {
		return new ConstantFormula(new BaseBitmap(filterConstraint.getPrimaryKeys()));
	}
