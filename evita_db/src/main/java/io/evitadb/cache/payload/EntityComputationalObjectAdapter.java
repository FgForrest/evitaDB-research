...
public class EntityComputationalObjectAdapter implements TransactionalDataRelatedStructure {
	 ...
	 */
	@Nonnull private final Supplier<SealedEntity> entityFetcher;
	/**
	 ...
	 */
	@Nonnull private final UnaryOperator<SealedEntity> entityEnricher;
	/**
	 ...
	 */
	@Nullable
	public SealedEntity fetchEntity() {
	 ...
	 */
	@Nonnull
	public SealedEntity enrichEntity(@Nonnull SealedEntity entity) {
