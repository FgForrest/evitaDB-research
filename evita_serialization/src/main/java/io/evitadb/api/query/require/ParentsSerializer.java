...
/**
 * This {@link Serializer} implementation reads/writes {@link Parents} from/to binary format.
 *
 * @author Jan Novotný (novotny@fg.cz), FG Forrest a.s. (c) 2022
 */
@RequiredArgsConstructor
public class ParentsSerializer extends Serializer<Parents> {

	@Override
	public void write(Kryo kryo, Output output, Parents object) {
	...
	@Override
	public Parents read(Kryo kryo, Input input, Class<? extends Parents> type) {
