...
public class SchemaSerializationService implements SerializationService<EntitySchema> {
	...
	public SchemaSerializationService(MutableCatalogEntityHeader catalogHeader) {
		this.kryo = KryoFactory.createKryo(catalogHeader.getClassResolver(), SchemaKryoConfigurer.INSTANCE);
	}
