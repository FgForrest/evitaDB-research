...
public class StoredVersionNotSupportedException extends SerializationException {
	...
	public StoredVersionNotSupportedException(Class<?> serializedClass, long encounteredVersion, Set<Long> currentlySupportedVersions) {
		super(
				"Cannot deserialize class " + serializedClass.getName() + " with serial version UID " + encounteredVersion + ". " +
					"Currently supported backward compatible versions for this class are: " +
