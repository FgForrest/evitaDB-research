 ...
 **/
public class ExcludingTranslator implements FilterConstraintTranslator<Excluding>,HierarchyTranslator {
    @Override
    public EsConstraint apply(Excluding excluding, EsQueryTranslator.FilterByVisitor filterByVisitor) {
        return new EsConstraint("excluding");
    }
}
