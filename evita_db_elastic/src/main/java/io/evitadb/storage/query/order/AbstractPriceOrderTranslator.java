 ...
 **/
public abstract class AbstractPriceOrderTranslator<C extends OrderConstraint> implements OrderConstraintTranslator<C> {
    ...
    protected EsOrderConstraint applyInternally() {
        return new EsOrderConstraint(
                new FieldSortBuilder("finalPrice")
                        .order(getSortOrder())
