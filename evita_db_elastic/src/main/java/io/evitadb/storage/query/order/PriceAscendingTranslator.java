 ...
 **/
public class PriceAscendingTranslator extends AbstractPriceOrderTranslator<PriceAscending> {
    ...
    @Override
    public EsOrderConstraint apply(PriceAscending ascending, OrderByVisitor orderByVisitor) {
