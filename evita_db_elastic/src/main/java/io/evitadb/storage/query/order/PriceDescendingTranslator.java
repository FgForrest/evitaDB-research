 ...
 **/
public class PriceDescendingTranslator extends AbstractPriceOrderTranslator<PriceDescending> {
    ...
    @Override
    public EsOrderConstraint apply(PriceDescending ascending, OrderByVisitor orderByVisitor) {
