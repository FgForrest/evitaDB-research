 ...
 **/
public class DirectRelationTranslator implements FilterConstraintTranslator<DirectRelation>,HierarchyTranslator {
    @Override
    public EsConstraint apply(DirectRelation directRelation, FilterByVisitor filterByVisitor) {
        return new EsConstraint("directRelation");
    }
}
