 ...
 **/
public class AscendingTranslator extends AbstractOrderConstraintTranslator<Ascending> {
    ...
    @Override
    public EsOrderConstraint apply(Ascending ascending, OrderByVisitor orderByVisitor) {
