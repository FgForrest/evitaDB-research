 ...
 **/
public class ExcludingRootTranslator implements FilterConstraintTranslator<ExcludingRoot>,HierarchyTranslator {
    @Override
    public EsConstraint apply(ExcludingRoot excludingRoot, EsQueryTranslator.FilterByVisitor filterByVisitor) {
        return new EsConstraint("excludingRoot");
    }
}
