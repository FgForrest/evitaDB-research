 ...
 **/
public class NotTranslator implements FilterConstraintTranslator<Not> {

    @Override
    public EsConstraint apply(Not constraint, EsQueryTranslator.FilterByVisitor filterByVisitor) {
