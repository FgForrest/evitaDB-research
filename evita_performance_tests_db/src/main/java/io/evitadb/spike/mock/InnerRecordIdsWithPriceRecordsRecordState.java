...
public class InnerRecordIdsWithPriceRecordsRecordState {
	...
	public void setUp() {
		...
		Arrays.sort(entitiesPriceRecordsA, Comparator.comparingInt(PriceRecordInnerRecordSpecific::getEntityPrimaryKey));
		...
		Arrays.sort(entitiesPriceRecordsB, Comparator.comparingInt(PriceRecordInnerRecordSpecific::getEntityPrimaryKey));
		...
		Arrays.sort(entitiesPriceRecordsC, Comparator.comparingInt(PriceRecordInnerRecordSpecific::getEntityPrimaryKey));
	...
	private Bitmap generateBitmap(int priceCount, CompositeObjectArray<PriceRecordInnerRecordSpecific> priceRecords) {
		...
		while (counter < priceCount) {
			...
			for (int i = 0; i < random.nextInt(10); i++) {
				...
				bitmap.add(priceRecord.getEntityPrimaryKey());
